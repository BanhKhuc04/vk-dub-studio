...
class UpdateDialog(QDialog):
    ...
    def __init__(self, update_info: UpdateInfo, parent: QWidget | None = None) -> None:
        ...
        ver_lbl.setStyleSheet("font-size: 13px;")
    ...
    def _start_download(self) -> None:
        ...
        self.lbl_status.setText("Đang kết nối tải bản cài đặt…")
        ...
        if success:
            ...
            if ret == QMessageBox.StandardButton.Yes:
                try:
                    ...
                    err_msg = f"Không thể khởi chạy installer: {exc}"
                    QMessageBox.critical(self, "Lỗi cài đặt", err_msg)
            else:
                self.accept()
        else:
