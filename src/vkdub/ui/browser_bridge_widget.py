...
class BrowserBridgeWidget(QFrame):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        header_title.setStyleSheet("font-size: 11px; font-weight: bold; color: #58a6ff;")
        ...
        self.btn_open_browser.setToolTip("Mở trình duyệt Microsoft Edge bình thường của bạn")
    ...
    def update_status(self, status: BridgeStatus) -> None:
        ...
        if status.browser_connected:
            ...
            self.lbl_browser.setStyleSheet("color: #3fb950; font-weight: bold; font-size: 11px;")
            self.btn_open_browser.setText("🌐 Mở Tab Mới Edge")
            self.btn_open_browser.setStyleSheet("background-color: #21262d; color: #c9d1d9;")
        else:
            self.lbl_browser.setText("○ Trình duyệt Edge: Đang chờ mở...")
            self.lbl_browser.setStyleSheet("color: #d29922; font-weight: normal; font-size: 11px;")
        ...
        if not status.browser_connected:
            ...
            self.lbl_chatgpt.setStyleSheet("color: #3fb950; font-weight: 500; font-size: 11px;")
        else:
            self.lbl_chatgpt.setText("▲ ChatGPT: Chưa đăng nhập trong Edge")
            self.lbl_chatgpt.setStyleSheet("color: #f85149; font-weight: bold; font-size: 11px;")
        ...
        if not status.browser_connected:
            ...
            self.lbl_vbee.setStyleSheet("color: #3fb950; font-weight: 500; font-size: 11px;")
        else:
            self.lbl_vbee.setText("▲ Vbee Công ty: Chưa đăng nhập trong Edge")
            self.lbl_vbee.setStyleSheet("color: #f85149; font-weight: bold; font-size: 11px;")
